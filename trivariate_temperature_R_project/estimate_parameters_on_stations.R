...
#+ ghcnd-stations-tmin-95p-hhy-params-n-events.png
ggplot(data = world) +
  geom_sf(fill = NA) +
...
#+ ghcnd-stations-tmin-95p-hhy-params-q-hat-complement.png
ggplot(data = world) +
  geom_sf(fill = NA) +
  coord_sf(xlim = ca_bbox[1:2],
           ylim = ca_bbox[3:4]) +
...
#+ ghcnd-stations-tmin-95p-hhy-params-p-hat.png
ggplot(data = world) +
  geom_sf(fill = NA) +
  coord_sf(xlim = ca_bbox[1:2],
           ylim = ca_bbox[3:4]) +
...
#+ghcnd-stations-tmin-95p-hhy-params-p-hat-inv.png
ggplot(data = world) +
  geom_sf(fill = NA) +
  coord_sf(xlim = ca_bbox[1:2],
           ylim = ca_bbox[3:4]) +
...
# bhat by station ---------------------------------------------------------
#+ ghcnd-stations-tmin-95p-hhy-params-b-hat.png
ggplot(data = world) +
  geom_sf(fill = NA) +
  coord_sf(xlim = ca_bbox[1:2],
           ylim = ca_bbox[3:4]) +
...
#+ ghcnd-stations-tmin-95p-hhy-params-b-hat-inv.png
ggplot(data = world) +
  geom_sf(fill = NA) +
  coord_sf(xlim = ca_bbox[1:2],
           ylim = ca_bbox[3:4]) +
